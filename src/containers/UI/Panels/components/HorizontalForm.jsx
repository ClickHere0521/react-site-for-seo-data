...
const HorizontalForm = ({ handleSubmit, reset }) => {
  ...
  const introduction = [
    {
      type: 'google',
      text: `As one of our most advanced products, Google Organic Search API encompasses a broad range of parameters and custom settings. 
      After you sort them out and make a call, the response will provide you with a complete real-time depiction of Google search results, 
      including structured data on every available SERP feature and a URL to the actual search results page.`,
    },
    {
      type: 'bing',
