...
export default async (dataApiProps, handleResult) => {
    ...
    try {
        await axios({
            method: 'post',
            url: 'https://sandbox.dataforseo.com/v3/keywords_data/google_trends/explore/task_post',
            auth: {
            ...
            try {
                await axios({
                    method: 'get',
                    url: `https://sandbox.dataforseo.com/v3/keywords_data/google_trends/explore/task_get/${result.id}`,
                    auth: {
                        username: 'effortsclickhere0901@gmail.com',
                        password: '9815613a0ce27ac5',
                    },
